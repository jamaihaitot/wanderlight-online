...
namespace SpacetimeDB.Types
{
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "PlayerConnect" => BSATNHelpers.Decode<Reducer.PlayerConnect>(encodedArgs),
                "PlayerDisconnect" => BSATNHelpers.Decode<Reducer.PlayerDisconnect>(encodedArgs),
                "ResetWorld" => BSATNHelpers.Decode<Reducer.ResetWorld>(encodedArgs),
                "SetDisplayName" => BSATNHelpers.Decode<Reducer.SetDisplayName>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.PlayerConnect args => Reducers.InvokePlayerConnect(eventContext, args),
                Reducer.PlayerDisconnect args => Reducers.InvokePlayerDisconnect(eventContext, args),
                Reducer.ResetWorld args => Reducers.InvokeResetWorld(eventContext, args),
